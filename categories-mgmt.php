    ...
    <div class="form-group col-xs-3">
      <div id="top-table">
        <ul class="list-inline">
          <li><a href="#" id="add_new" data-toggle="modal" data-target="#subc-modal"><span class="fa fa-plus"></span> Add</a></li>
          <li><a href="#"><span class="fas fa-sync-alt"></span> Refresh</a></li>
        </ul>
      </div>
